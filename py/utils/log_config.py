...
def init_log():
    ...
    if len(_logger.handlers) == 0:  # 避免重复
        ...
        # print('dsadasdsadas============'+str(logging.FileHandler.baseFilename))
        fh = logging.FileHandler(logging.FileHandler.baseFilename)  # 默认mode 为a模式，默认编码方式为utf-8
        ...
        _logger.info(f'初始化的日志路径：{logging.FileHandler.baseFilename}')
